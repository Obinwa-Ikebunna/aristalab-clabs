...
This Lab simulates a data center environment! Mostly sourced from an arista training. Make adjustments to suite your lab environment.

Each folder consists of a lab separate on its own.

Use these steps and show command outputs in each folder to complete each lab (the show commands can be used as a reference or templates to configure your switches as desired)
